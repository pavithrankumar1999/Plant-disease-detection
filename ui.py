...
title = tk.Label(text="Upload A Image To Analyse", background = "black", fg="white", font=("", 15))
title.grid()
def bact():
    window.destroy()
    window1 = tk.Tk()
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:\\Users\\sagpa\\Downloads\\images', title='Select image for analysis ',filetypes=[('image files', '.jpg')])
    print(fileName)
    dst = "D:\\raindrop\\New folder"
